...
public class CashRegisterTest {
    ...
    /**
     * Tests if the method calculateSalesPerVolume() returns the expected value. The method returns a double array with the values of {sumNonAlcoholic,sumMildAlcoholic,sumStrongAlcoholic}.
